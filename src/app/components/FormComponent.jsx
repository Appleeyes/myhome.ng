...
function FormComponent({ fields, submitButtonText, additionalTagText, additionalTagLinkText, additionalTagLink }) {
    ...
    return (
        <form className="form-container">
            ...
            <div className="additional-tag">
                {additionalTagText} <Link to={additionalTagLink}>{additionalTagLinkText}</Link>
            </div>
        </form>
    );
}
